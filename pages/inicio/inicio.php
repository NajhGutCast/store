...
<body class="loading" data-layout='{"mode": "light", "width": "fluid", "menuPosition": "fixed", "sidebar": { "color": "dark", "size": "default", "showuser": true}, "topbar": {"color": "dark"}, "showRightSidebarOnPageLoad": true}'>
          ...
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="dropdown float-end">
                    <a href="./activities/pending">
                      <i class="mdi mdi-arrow-top-right arrow-none"></i>
                    </a>
                  </div>

                  <h4 class="header-title mt-0 mb-4">Actividades pendientes</h4>
                  ...
                  <div class="widget-chart-1">
                    ...
                    <div class="widget-detail-1 text-end">
                      <h2 class="fw-normal pt-2 mb-1"> 54 </h2>
                      <p class="text-muted mb-1">20 antiguas</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card">
                <div class="card-body">
                  <div class="dropdown float-end">
                    <a href="./activities/done">
                      <i class="mdi mdi-arrow-top-right arrow-none"></i>
                    </a>
                  </div>

                  <h4 class="header-title mt-0 mb-4">Actividades realizadas</h4>
                  ...
                  <div class="widget-chart-1">
                    ...
                    <div class="widget-detail-1 text-end">
                      ...
                      <p class="text-muted mb-1">faltan evidencias</p>
                    </div>
                  </div>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card">
                <div class="card-body">
                  <div class="dropdown float-end">
                    <a href="./activities/toreview">
                      <i class="mdi mdi-arrow-top-right arrow-none"></i>
                    </a>
                  </div>

                  <h4 class="header-title mt-0 mb-3">Actividades para revisar</h4>

                  <div class="widget-box-2">
                    <div class="widget-detail-2 text-end">
                      <span class="badge bg-success rounded-pill float-start mt-3">32% <i class="mdi mdi-trending-up"></i> </span>
                      <h2 class="fw-normal mb-1"> 45 </h2>
                      <p class="text-muted mb-3"> aceptar o rechazar </p>
                    </div>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card">
                ...
                <div class="dropdown float-end">
                  ...
                  <h4 class="header-title mt-0 mb-3">Actividades revisadas</h4>

                  <div class="widget-box-2">
                    <div class="widget-detail-2 text-end">
                      <span class="badge bg-pink rounded-pill float-start mt-3">32% <i class="mdi mdi-trending-up"></i> </span>
                      <h2 class="fw-normal mb-1"> 75 </h2>
                      <p class="text-muted mb-3"> Generar reporte </p>
                    </div>
  ...
  <script type="text/javascript" src="./assets/libs/morris.js06/morris.min.js"></script>
  <script type="text/javascript" src="./assets/js/pages/dashboard.init.js"></script>
